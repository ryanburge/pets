...
reg1 <- glm.nb(numpets ~ attend*reltrad + white + male + income2 + pid72 + childs2 + age2 + educ2 + urban + literal , data = int)
...
gg2 +
  labs(x = "Church Attendance", y = "Prediciting Number of Pets", title = "The Interaction Between Church Attendance and Number of Pets", caption = "Data: GSS 2018") +
  theme_gg("Montserrat") +
